...
declare global {
	namespace Resolvers {
		...
		> = {
			...
			>;
			login?: Resolver<
				Maybe<ResolversTypes['LoginReturn']>,
				ParentType,
				ContextType,
		...
		export type LoginReturnResolvers<
			ContextType = any,
			ParentType extends ResolversParentTypes['LoginReturn'] = ResolversParentTypes['LoginReturn']
		> = {
		...
		> = {
			...
			chatGroups?: Resolver<
				Array<ResolversTypes['ChatGroup']>,
				ParentType,
				ContextType
			>;
			createdAt?: Resolver<
		...
		export type ChatGroupResolvers<
			ContextType = any,
			ParentType extends ResolversParentTypes['ChatGroup'] = ResolversParentTypes['ChatGroup']
		> = {
			id?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
			name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
			isPublic?: Resolver<
...
> = {
	...
	user?: Resolver<
		...
		RequireFields<QueryUserArgs, 'id'>
	>;
	changeLogById?: Resolver<
		ResolversTypes['ChangeLog'],
		ParentType,
		ContextType,
		RequireFields<QueryChangeLogByIdArgs, 'id'>
	>;
	changeLogs?: Resolver<
		Array<Maybe<ResolversTypes['ChangeLog']>>,
		ParentType,
		ContextType
	>;
};
...
> = {
	...
	verifyEmail?: Resolver<
		...
		RequireFields<MutationVerifyEmailArgs, 'token'>
	>;
	addNewChangeLog?: Resolver<
		ResolversTypes['ChangeLog'],
		ParentType,
		ContextType,
		RequireFields<MutationAddNewChangeLogArgs, 'newChangeLog'>
	>;
	editChangeLog?: Resolver<
		Maybe<ResolversTypes['ChangeLog']>,
		ParentType,
		ContextType,
		RequireFields<MutationEditChangeLogArgs, 'id'>
	>;
};
